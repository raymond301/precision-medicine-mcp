...
### Compute (Cloud Run)
- **MCP Servers** ([Server Registry](../reference/shared/server-registry.md)): fgbio, multiomics, spatialtools, tcga, openimagedata, deepcell, huggingface, seqera, mockepic, epic, cell-classify, genomic-results, patient-report, perturbation, quantum-celltype-fidelity.
