...
### Compute (Cloud Run)
- **15 MCP Servers:** fgbio, multiomics, spatialtools, tcga, openimagedata, deepcell, huggingface, seqera, mockepic, epic, cell-classify, genomic-results, patient-report, perturbation, quantum-celltype-fidelity.
