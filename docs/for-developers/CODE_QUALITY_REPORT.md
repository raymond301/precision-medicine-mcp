...
- mcp-perturbation: 8 tools (GEARS perturbation prediction)
- mcp-quantum-celltype-fidelity: 6 tools (quantum cell type validation)
- mcp-openimagedata: 5 tools (image data management)
- mcp-tcga: 5 tools (cancer genomics data queries)
- mcp-patient-report: 5 tools (patient-facing PDF reports)
- mcp-fgbio: 4 tools (genomics reference data, validation)
- mcp-epic: 4 tools (FHIR integration)
- mcp-genomic-results: 4 tools (somatic variants, CNV, HRD scoring)
- mcp-deepcell: 3 tools (cell segmentation)
- mcp-cell-classify: 3 tools (cell phenotype classification)
