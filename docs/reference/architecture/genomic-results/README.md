...
### Reference
- **[PatientOne Workflow](../../test-docs/patient-one-scenario/README.md)** - End-to-end precision medicine workflow
...
- [Genomic Cohorts (TCGA)](../genomic/README.md) - Population-level genomic context
- [Workflow Orchestration (Seqera)](../workflow/README.md) - Upstream nf-core/sarek pipeline
- [Multiomics Integration](../multiomics/README.md) - RNA/Protein/Phospho integration
