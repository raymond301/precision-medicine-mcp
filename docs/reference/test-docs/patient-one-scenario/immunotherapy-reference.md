...
- **[Prompt Library: Clinical & Genomic](../../prompt-library/clinical-genomic.md)** — Prompt 17: Immunotherapy targets
- **[Prompt Library: Workflows](../../prompt-library/workflows.md)** — Section 5b: Immunotherapy research workflow
- **[Prompt Library README](../../prompt-library/README.md)** — Full prompt index
