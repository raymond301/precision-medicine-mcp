#!/bin/bash
# Deploy Streamlit MCP Chat STUDENT APP to GCP Cloud Run
# This app has safety guardrails enabled
...
echo "=========================================="
echo "Deploying STUDENT MCP Chat to Cloud Run"
echo "=========================================="
echo "⚠️  STUDENT MODE ENABLED - Safety limits active"
