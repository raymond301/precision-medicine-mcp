...
**Part of the Precision Medicine MCP suite:** This server is a key component of comprehensive precision medicine workflows, demonstrated in the [PatientOne](../../../tests/manual_testing/PatientOne-OvarianCancer/README.md) example where it identifies treatment resistance mechanisms in Stage IV Ovarian Cancer.
