...
**Problem:** The comprehensive end-to-end test (COPY_PASTE_PROMPT.txt) hits Claude Desktop's context limit because it tries to load all data files and run all MCP servers at once.
